...
public class WTPDeploymentDescriptorManagement implements DeploymentDescriptorManagement {
  ...
  public void updateConfiguration(final IProject project, final  MavenProject mavenProject, final EarPluginConfiguration plugin, final boolean useSourceFolder, final
